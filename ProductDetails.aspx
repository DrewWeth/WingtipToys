...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <asp:FormView ID="productDetail" runat="server" ItemType="WingtipToys.Models.Product" SelectMethod ="GetProduct" RenderOuterTable="true">
        <ItemTemplate>
            <div>
            ...
            <table>
                <tr>
                    ...
                    <td style="vertical-align: top; text-align:left;">
                        ...
                        <br />
                        <span><b>Price:</b>&nbsp;<%#: Item.UnitPrice %></span>
                        <br />
